<div class="modal fade" id="modal-domesticflight" tabindex="-1" role="dialog" aria-labelledby="modal-domesticflight" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="card card-plain">
                    <div class="card-header pb-0 text-left">
                        <h6 class="mb-0 text-primary">Add New Domestic Flight</h6>
                    ...
                    <div class="card-body">
                        <form action="{{ route('domestic_flights.store') }}" method="post">
                            ...
                            <div class="input-group input-group-static mb-4">
                                <label for="reserve_code">Record</label>
